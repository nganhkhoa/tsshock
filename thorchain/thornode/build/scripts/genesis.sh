...
if [ "$SEED" = "$(hostname)" ]; then
  ...
  if [ ! -f ~/.thornode/config/genesis.json ]; then
    ...
    NODE_IP_ADDRESS=${EXTERNAL_IP:=$(hostname -i)}
    ...
    if [ "$NET" = "mocknet" ]; then
      ...
      add_account tthor1uuds8pd92qnnq0udw0rpg0szpgcslc9p8lluej rune 200000000000000000 # cat
      add_account tthor1zf3gsk7edzwl9syyefvfhle37cjtql35h6k85m rune 200000000000000000 # dog
      add_account tthor13wrmhnh2qe98rjse30pl7u6jxszjjwl4f6yycr rune 200000000000000000 # fox
      add_account tthor1qk8c8sfrmfm0tkncs0zxeutc8v5mx3pjj07k4u rune 200000000000000000 # pig
      add_account tthor1dcx60m4dxx7jcy97l26rk7j86hjjy900r9976h rune 200000000000000000 # acc1
